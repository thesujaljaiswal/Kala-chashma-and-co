              ...
              <div className="pt-6 border-t border-white/10">
                ...
                <div className="space-y-3">
                  {stations.map((station, index) => (
                    <div key={index} className="flex gap-3 items-center bg-black/10 p-2 rounded-2xl border border-white/5">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10 bg-white/5">
                  <th className="py-5 px-6 font-semibold text-gray-300">Passenger Name</th>
                  <th className="py-5 px-6 font-semibold text-gray-300">Phone</th>
                  <th className="py-5 px-6 font-semibold text-gray-300">Boarding Station</th>
                  <th className="py-5 px-6 font-semibold text-gray-300 text-right">Submitted At</th>
                </tr>
              </thead>
              <tbody>
                {selections.length === 0 ? (
