...
export default function AdminSidebar({ activeTab, title }: { activeTab: "manage" | "onboarding" | "checkin", title: string }) {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center justify-between p-4 border-b border-white/10 bg-gray-900/80 backdrop-blur-md sticky top-0 z-30 w-full absolute">
